...
float MLX90640_GetVdd(uint16_t frameData[836], const paramsMLX90640 *params);

void byte_swap_uint16(uint16_t& bytes_to_swap) {
    bytes_to_swap = (bytes_to_swap >> 8) | (bytes_to_swap << 8);
}

int MLX90640_ExtractParameters(uint16_t eeData[832], paramsMLX90640 *mlx90640) {
...
//------------------------- To calculation -------------------------------------    
    ...
    for (int pixelNumber = 0; pixelNumber < 768; pixelNumber++) {
        ...
        if (pattern == (frameData[833] & 0xfff7)) {
            ...
            float alphaCompensated = SCALEALPHA * alphaScale/params->alpha[pixelNumber];
...
#ifdef MLX90640_DEBUG
    printf("kVdd: "); printf(kVdd); printf("\r\n");
    printf("vdd25: "); printf(vdd25); printf("\r\n");
#endif
}
...
#ifdef MLX90640_DEBUG
    printf("KvPTAT: "); printf(KvPTAT, 8); printf("\r\n");
    printf("KtPTAT: "); printf(KtPTAT); printf("\r\n");
    printf("vPTAT25: "); printf(vPTAT25); printf("\r\n");
    printf("alphaPTAT: "); printf(alphaPTAT); printf("\r\n");
#endif
}
...
#ifdef MLX90640_DEBUG
    printf("gainEE: "); printf(gainEE); printf("\r\n");
#endif
}
...
void ExtractTgcParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    ...
    mlx90640->tgc = tgc;        
#ifdef MLX90640_DEBUG
    printf("tgc: "); printf(tgc, 8); printf("\r\n");
#endif
}
...
#ifdef MLX90640_DEBUG
    printf("ResolutionEE: "); printf(resolutionEE); printf("\r\n");
#endif
}
...
void ExtractKsTaParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    ...
    mlx90640->KsTa = KsTa;
#ifdef MLX90640_DEBUG
    printf("KsTa: "); printf(KsTa, 8); printf("\r\n");
#endif
}
...
void ExtractKsToParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    ...
    printf("KsTo: "); 
    for (int i=0; i<5; i++) {
      printf(mlx90640->ksTo[i], 8);
      printf(", ");
    }
     printf("\r\n");
    printf("ct: "); 
    for (int i=0; i<5; i++) {
      printf(mlx90640->ct[i]);
      printf(", ");
    }
     printf("\r\n");
#endif
...
void ExtractAlphaParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
...
#ifdef MLX90640_DEBUG
    printf("Temp: "); printf(temp); printf("\r\n");
#endif
    ...
    printf("alpha: "); 
    for (int i=0; i<768; i++) {
      printf(mlx90640->alpha[i]);
      printf(", ");
    }
     printf("\r\n"); 
    printf("alphascale: "); printf(alphaScale); printf("\r\n");
#endif
}
...
void ExtractKtaPixelParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    ...
    printf("kta: "); 
    for (int i=0; i<768; i++) {
      printf(mlx90640->kta[i]);
      printf(", ");
    }
     printf("\r\n"); 
    printf("ktascale: "); printf(ktaScale1); printf("\r\n");
#endif
}
...
void ExtractKvPixelParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    ...
    printf("kv: "); 
    for (int i=0; i<768; i++) {
      printf(mlx90640->kv[i]);
      printf(", ");
    }
     printf("\r\n"); 
    printf("kvscale: "); printf(kvScale); printf("\r\n");
#endif
}
...
#ifdef MLX90640_DEBUG
    printf("cpAlpha: "); printf(alphaSP[0], 12);
    printf(", ");  printf(alphaSP[1], 12); printf("\r\n");
    printf("offsetSP: "); printf(offsetSP[0]);
    printf(", ");  printf(offsetSP[1]); printf("\r\n");
#endif
}
...
#ifdef MLX90640_DEBUG
    printf("calibEE: "); printf(calibrationModeEE); printf("\r\n");
    printf("ilChess: "); printf(ilChessC[0]);
    printf(", ");  printf(ilChessC[1]);
    printf(", ");  printf(ilChessC[2]); printf("\r\n");
#endif
}
...
int ExtractDeviatingPixels(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    ...
    if(brokenPixCnt > 4) {
        printf("Broken pixels: %d\r\n", brokenPixCnt);
        warn = -3;
    }
    else if(outlierPixCnt > 4) {
        printf("Outlier pixels: %d\r\n", outlierPixCnt);
        warn = -4;
    }
    else if((brokenPixCnt + outlierPixCnt) > 4) {
        printf("Broken+outlier pixels: %d\r\n", brokenPixCnt + outlierPixCnt);
        warn = -5;
    } 
    else {
        for(pixCnt=0; pixCnt<brokenPixCnt; pixCnt++) {
            for(i=pixCnt+1; i<brokenPixCnt; i++) {
                ...
                if(warn != 0) {
                    printf("Broken pixel has adjacent broken pixel\r\n");
                    return warn;
                }
            }
        }
        for(pixCnt=0; pixCnt<outlierPixCnt; pixCnt++) {
            for(i=pixCnt+1; i<outlierPixCnt; i++) {
                ...
                if(warn != 0) {
		            printf("Outlier pixel has adjacent outlier pixel\r\n");
                    return warn;
                }
            }
        } 
        for(pixCnt=0; pixCnt<brokenPixCnt; pixCnt++) {
            for(i=0; i<outlierPixCnt; i++) {
                ...
                if(warn != 0) {
		            printf("Broken pixel has adjacent outlier pixel\r\n");
                    return warn;
                }
            }
        }
